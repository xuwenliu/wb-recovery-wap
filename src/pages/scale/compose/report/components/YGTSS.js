              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore1 < 25 ? <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="轻度" />
                  </TableCell>
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore1 >= 25 && buttonScore1 <= 50?  <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="中度" />
                  </TableCell>
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore1 > 50 ? <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="重度" />
                  </TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore2 < 25 ? <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="轻度" />
                  </TableCell>
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore2 >= 25 && buttonScore2<= 50?  <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="中度" />
                  </TableCell>
                  <TableCell align="center" rowSpan={2} colSpan={2}>
                    <FormControlLabel control={buttonScore2 > 50 ? <CheckBoxIcon color="primary"/>:<CheckBoxOutlineBlankIcon/>} label="重度" />
                  </TableCell>
                </TableRow>
                <TableRow>
